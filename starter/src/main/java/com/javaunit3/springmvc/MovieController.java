...
// define a class MovieController, and annotate it appropriately so that Spring recognizes it as a controller.
@Controller
public class MovieController {
    ...
    public String voteForBestMoviefFormPage(Model model) {
